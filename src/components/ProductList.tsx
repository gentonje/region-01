...
const ProductSkeleton = memo(() => (
  <div className="space-y-3 rounded-xl overflow-hidden bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 p-4 shadow-md">
...
export const ProductList = ({
  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-8 rounded-xl mt-4 bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700">
