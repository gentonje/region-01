...
export const ProductList = ({
  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-1 m-1 mt-1">
  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-1 rounded-xl mt-1 bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700 m-1">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-1 m-1 mt-1">
