    ...
    >
      <CardContent className="px-0 space-y-2 relative">
        ...
        >
          ...
          <span className="absolute -bottom-3 left-1/2 -translate-x-1/2 text-sm px-2 py-1 rounded-full bg-white/80 backdrop-blur-sm text-orange-500 font-medium whitespace-nowrap">
