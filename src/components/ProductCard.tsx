...
const ProductCard = ({
  ...
  return (
    <Card className="w-full overflow-hidden group relative transition-all duration-300 hover:shadow-xl bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 space-y-1 p-1">
      <ProductCardImage
        product={product}
        imageUrl={imageUrl}
